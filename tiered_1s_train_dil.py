    ...
    for train_episode in range(0, TRAIN_EPISODE):
        ...
        if (train_episode + 1) % 5000 == 0:
            ...
            with torch.no_grad():
                ...
                print("score_multi:", rewardsm, "score_21:", rewards0, "score_10:", rewards1, "score_13:", rewards2,
...
"""
name: tieredImageNet数据集上的5-way 1-shot训练，并实现特征金字塔结构进行多层次的模型训练
description: Adam,CE,KL,学习率0.001每15w轮减半,关系网络为3个RN2，
             没有上采样基础模型2.0版本,加上了类似知识蒸馏的软标签损失传递
"""